...
namespace SE347.L11_HelloWork.Controllers
{
    ...
    public class TokenAuthController : L11_HelloWorkControllerBase
    {
        ...
        public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            var userRole = await _userRoleRepository.GetAll()
                .Where(ur => ur.UserId == loginResult.User.Id)
                .FirstOrDefaultAsync();

            
            var role = await _roleRepository.GetAllIncluding(r => r.Permissions).Where(r => r.Id == userRole.RoleId).FirstOrDefaultAsync();
