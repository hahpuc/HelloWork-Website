...
namespace SE347.L11_HelloWork.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = L11_HelloWorkConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(L11_HelloWorkDbContext context)
        {
            _context = context;
        }
