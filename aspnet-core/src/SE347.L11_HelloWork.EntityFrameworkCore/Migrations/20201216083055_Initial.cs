        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicStatus = table.Column<int>(nullable: false),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    LastModifierUserId = table.Column<long>(nullable: true),
                    LastModificationTime = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDJobSeeker = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadcountLimit = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "CVEmployeeInformations",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    NameCV = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CVEmployeeInformations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDInterview = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDJobSeeker = table.Column<int>(nullable: false),
                    IDRecruitment = table.Column<int>(nullable: false),
                    Location = table.Column<string>(nullable: true),
                    InterviewTime = table.Column<DateTime>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    LastModifierUserId = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "OrientationOfJobSeekers",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdOrientation = table.Column<int>(nullable: true),
                    IdJobSeeker = table.Column<int>(nullable: true),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    LastModifierUserId = table.Column<long>(nullable: true),
                    LastModificationTime = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrientationOfJobSeekers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WayOfWork = table.Column<string>(nullable: true),
                    SalaryRange = table.Column<string>(nullable: true),
                    UrgentLevel = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemainUseTimes = table.Column<int>(nullable: false),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    LastModifierUserId = table.Column<long>(nullable: true),
                    LastModificationTime = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RatingStar = table.Column<float>(nullable: true),
                    NumberOfReview = table.Column<long>(nullable: true),
                    IDJobSeeker = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    CreatorUserId = table.Column<long>(nullable: true),
                    LastModifierUserId = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedRecruitments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillOfJobSeekers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StateApplicants", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "StateApplications",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StateApplications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInfos_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDCurrentPosition = table.Column<long>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    Email = table.Column<string>(nullable: true),
                    PhoneNumber = table.Column<string>(nullable: true),
                    Address = table.Column<string>(nullable: true),
                    NoIDCard = table.Column<string>(nullable: true),
                    Image = table.Column<string>(nullable: true),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    LastModifierUserId = table.Column<long>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recruiters_Companies_IDCompany",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CVEmployeeInformationID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AchievementDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AchievementDetails_CVEmployeeInformations_CVEmployeeInformationID",
                        column: x => x.CVEmployeeInformationID,
                        principalTable: "CVEmployeeInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EducationDetails_CVEmployeeInformations_CVEmployeeInformationID",
                        column: x => x.CVEmployeeInformationID,
                        principalTable: "CVEmployeeInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExperienceDetails_CVEmployeeInformations_CVEmployeeInformationID",
                        column: x => x.CVEmployeeInformationID,
                        principalTable: "CVEmployeeInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SkillDetails_CVEmployeeInformations_CVEmployeeInformationID",
                        column: x => x.CVEmployeeInformationID,
                        principalTable: "CVEmployeeInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpertiseRecruitments", x => new { x.RecruitmentId, x.ExpertiseId });
                    table.ForeignKey(
                        name: "FK_ExpertiseRecruitments_Expertises_ExpertiseId",
                        column: x => x.ExpertiseId,
                        principalTable: "Expertises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpertiseRecruitments_Recruitments_RecruitmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    IDJobSeeker = table.Column<int>(nullable: false),
                    IDRecruiter = table.Column<int>(nullable: false),
                    IsRecruiterWrite = table.Column<bool>(nullable: false),
                    Id = table.Column<int>(nullable: false),
                    Reason = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    StarNumber = table.Column<float>(nullable: true),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    LastModifierUserId = table.Column<long>(nullable: true),
                    LastModificationTime = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => new { x.IDJobSeeker, x.IDRecruiter, x.IsRecruiterWrite });
                    table.ForeignKey(
                        name: "FK_Comments_JobSeekers_IDJobSeeker",
                        column: x => x.IDJobSeeker,
                        principalTable: "JobSeekers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_Recruiters_IDRecruiter",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AchievementDetails_CVEmployeeInformationID",
                table: "AchievementDetails",
                column: "CVEmployeeInformationID");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_IDRecruiter",
                table: "Comments",
                column: "IDRecruiter");

            migrationBuilder.CreateIndex(
                name: "IX_EducationDetails_CVEmployeeInformationID",
                table: "EducationDetails",
                column: "CVEmployeeInformationID");

            migrationBuilder.CreateIndex(
                name: "IX_ExperienceDetails_CVEmployeeInformationID",
                table: "ExperienceDetails",
                column: "CVEmployeeInformationID");

            migrationBuilder.CreateIndex(
                name: "IX_ExpertiseRecruitments_ExpertiseId",
                table: "ExpertiseRecruitments",
                column: "ExpertiseId");

            migrationBuilder.CreateIndex(
                name: "IX_Recruiters_IDCompany",
                table: "Recruiters",
                column: "IDCompany");

            migrationBuilder.CreateIndex(
                name: "IX_SkillDetails_CVEmployeeInformationID",
                table: "SkillDetails",
                column: "CVEmployeeInformationID");
