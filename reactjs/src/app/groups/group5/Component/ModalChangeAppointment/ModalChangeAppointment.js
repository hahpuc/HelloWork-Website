...
import './ModalChangeAppointment.less'
...
export default class ModalChangeAppointment extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                {this.props.shadow ? <div className="Custom_Modal_Out_Shadow1" /> : <></>}

                <div className="Custom_Modal_Out_Layout1">
                    <div className="Custom_Modal_Wrapper1">
                        {!(this.props.type === "custom") ?
                            <>
                                <div className="Custom_Modal_Header1">
                                    <div> {this.props.title} </div>
                                    <img className="Custom_Modal_Close_Button1" alt="header" src={red_delete_icon}
                                        onClick={() => this.props.closeModal()} />
                                </div>

                                <div className="Custom_Modal_Body1">
                                    ...
                                    <div className="Custom_Modal_Main_Content_Layout1">
                                        <div className="Custom_Modal_Main_Text1">
                                            {this.props.text}
                                        </div>
                                    </div>
                                </div>
                                ...
                                {(this.props.type === "confirmation") ?
                                    <div className="Custom_Modal_Footer1">
                                        {this.props.children}
                                    </div>
                                    : <></>
                                }
                                ...
                                {(this.props.type === "alert_success" || this.props.type === "alert_fail") ?
                                    <div className="Custom_Modal_Footer1">
                                        <div className="Simple_Blue_Button1" style={{ margin: "auto" }} onClick={() => this.props.closeModal()} >OK</div>
                                    </div>
                                    : <></>
                                }
                            </>
